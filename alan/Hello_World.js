...
let chooseFood = context(() => {
    follow('(make|cook) $(FOOD pasta with mince|potato salad)', p => {
        if (p.FOOD.value === 'pasta with mince') {
            ...
            p.play('To make potato salad, follow these steps: Peel your potatoes. Add them to a pot and boil them. While the potatoes are boiling, dice your sausage and onions into small cubes. When the potatoes are boiled, dice them into small cubes. Add everything to a big bowl or pot. Add salt according to taste. Mix everything together. Chill in the freezer for at least an hour.');
        } else {
            p.play("I'm sorry, I don't have a recipe for that dish. Please choose between pasta with mince or potato salad.");
        }
    });
});