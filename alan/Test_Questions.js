...
intent('(Can|Could) you give me all of the mojito ingredients?', 'What are the ingredients of a mojito', p => {
...
intent('(Can|Could) you give me all of the cuba libre ingredients?', 'What are the ingredients of a cuba libre', p => {
    p.play('Of course, cuba libre has 4 ingredients. You will need 60 ml dark rum, 120-180 ml cola, lime wedges, ice cubes');
});

intent('(Can|Could) you tell me how to make a cuba libre?', 'Make a cuba libre', p => {
...
intent('(Can|Could) you give me all of the pina colada ingredients?', 'What are the ingredients of a pina colada', p => {
...
intent('(Can|Could) you tell me how to make a pina colada?', 'Make a pina colada', p => {
...
intent('What ingredients do I need to make pasta with minced meat', '(Can|Could) you give me all of the ingredients for pasta with minced meat', p => {
    p.play('300-500 grams of minced pork or beef, 1-2 onions, 2-4 cloves of garlic, 300 grams of pasta');
});

intent('(Can|Could) you tell me how to make pasta with minced meat', 'Make pasta with minced meat', p => {
...
intent('What ingredients do I need to make a potato salad', '(Can|Could) you give me all of the ingredients for potato salad', p => {
...
intent('(Can|Could) you tell me how to make a classic potato salad', 'Make a potato salad', p => {
